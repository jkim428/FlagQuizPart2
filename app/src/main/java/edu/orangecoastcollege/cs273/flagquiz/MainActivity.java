...
public class MainActivity extends AppCompatActivity {
    ...
    public void resetQuiz() {
        ...
        // COMPLETED: Randomly add FLAGS_IN_QUIZ (10) countries from the mAllCountriesList (mFilteredCountriesList) into the mQuizCountriesList
    ...
    private void loadNextFlag() {
        ...
        int questionNumber = FLAGS_IN_QUIZ - mQuizCountriesList.size(); // Or mCorrectGuesses + 1
    ...
    public void makeGuess(View v) {
        ...
        mTotalGuesses++; // Every time user makes guesses TotalGuesses is increased.
        ...
        {
            // Disable all buttons (don't let user guess again) - for each loop
    ...
    // Respond to the user clicking the Settings menu icon
    @Override
    ...
    private void updateChoices() {
        // Enable all the linear layouts < mChoices / 2
    ...
    private void updateRegion() {
        // Make a decision:
        // If the region is "All", filtered list is same as all
